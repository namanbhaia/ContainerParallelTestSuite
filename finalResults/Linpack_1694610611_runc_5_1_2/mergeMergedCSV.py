...
joinedCSV.rename( 
    columns={"TestNum": "ParallelNum", "DGEFA": "DGEFA%", "DGESL": "DGESL%", "OVERHEAD": "OVERHEAD%"},
    inplace=True,
)

dateTime = datetime.datetime.now();
dateTimeStr = dateTime.strftime("%d-%m-%Y_%H-%M-%S")
filename = os.getcwd() + "/LinpackCombinedRun_" + dateTimeStr;# + "_" + sys.argv[4] + "_" + sys.argv[1] + "_" + sys.argv[2] + "_" + sys.argv[3];
name = filename + ".csv";
