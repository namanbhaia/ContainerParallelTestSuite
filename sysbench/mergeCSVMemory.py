...
results = []
testNum = 1;
data = pd.DataFrame(columns=['TestNum', 'TotalTime(s)', 'NumEvents', 'DataTransfer(MiB)', 'MinRespTime(ms)', 'MaxRespTime(ms)', 'AvgRespTime(ms)', '95RespTime(ms)', 'ThreadFairEvt', 'ThreadFairStddev', 'EvtExecAvg', 'EvtExecStddev'])
string1 = "total time:";
string2 = "total number of events:";
string3 = "MiB transferred";
string4 = "min:";
string5 = "avg:";
string6 = "max:";
